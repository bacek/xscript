...
public:
    ...
    virtual int write(Response *response, xmlDocPtr doc, xmlOutputBufferPtr buf) = 0;
};
...
public:
    ...
    virtual void write(std::ostream *os, const Response *response) const = 0; // TODO: remove const
