...
#ifdef DEBUG
#define __pcredebug std::cerr << "(pcre++ DEBUG) " << __LINE__ << ": " 
#else
#define __pcredebug if(0) std::cerr 
#endif
...
public:
   ...
   */
    ...
    public:
        ...
        exception(int num) : std::runtime_error(translate(num)) { }
    };
    ...
    */
    std::string operator[](int index) { return get_match(index); }
}; 
