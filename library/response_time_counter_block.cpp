...
XmlDocHelper
ResponseTimeCounterBlock::call(boost::shared_ptr<Context>, boost::any &) throw (std::exception) {
...
XmlDocHelper
ResetResponseTimeCounterBlock::call(boost::shared_ptr<Context>, boost::any &) throw (std::exception) {
    XmlDocHelper doc(xmlNewDoc((const xmlChar*) "1.0"));
    XmlUtils::throwUnless(NULL != doc.get());
