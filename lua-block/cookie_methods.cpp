...
static const struct luaL_reg cookielib_m [] = {
    {"__gc",		luaCookieDelete
    },		// Destroy cookie

    {"name",		luaCookieName}, {"value",		luaCookieValue}, {"secure",	luaCookieSecure}, {"expires",	luaCookieExpires}, {"path",		luaCookiePath}, {"domain",	luaCookieDomain}, {"permanent", luaCookiePermanent}, {NULL, NULL}
};
